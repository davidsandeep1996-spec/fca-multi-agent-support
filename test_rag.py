...
TEST_CASES = [
    ...
    {
        "page": 1,
        "q": "Do I need to tell you before I travel abroad?",
        "expect": ["no", "notify"],
    },
    # --- PAGE 2 ---
    ...
    {
        "page": 2,
        "q": "Can I take a payment holiday on my personal loan?",
        "expect": ["one month", "12 months"],
    },
    {
        "page": 2,
    ...
    {
        "page": 2,
        "q": "Can I install the app on two phones?",
        "expect": ["one primary", "security"],
    },
    # --- PAGE 3 ---
    {
        "page": 3,
        "q": "What if I am struggling to pay my debts?",
        "expect": ["financial support", "forbearance"],
    },
    {
        "page": 3,
    ...
    {
        "page": 3,
        "q": "How can I get a copy of my bank statement?",
        "expect": ["7 years", "download"],
    },
    {
        "page": 3,
        "q": "What is a Basic Bank Account?",
        "expect": ["poor credit", "financial inclusion"],
    },
    {
        "page": 3,
        "q": "How do I upgrade my current account?",
        "expect": ["income verification", "app"],
    },
    # --- PAGE 4 ---
    {
        "page": 4,
    ...
    {
        "page": 4,
        "q": "What if someone sends money to my old account after switch?",
        "expect": ["redirected", "new account"],
    },
    {
        "page": 4,
        "q": "Can I switch if my account is overdrawn?",
        "expect": ["yes", "agree"],
    },
    {
        "page": 4,
        "q": "Do I need to tell my employer I am switching banks?",
        "expect": ["no", "automatically"],
    },
    # --- PAGE 5 ---
    {
        "page": 5,
    ...
    },
    {
        ...
        "expect": ["phishing@fca-bank.com", "forward"],
    },
    {
        "page": 5,
        "q": "Are my cryptocurrency purchases protected?",
        "expect": ["no", "unregulated"],
    },
    {
        "page": 5,
        "q": "How do I cancel a Direct Debit?",
        "expect": ["app", "one working day"],
    },
    # --- PAGE 6 ---
    {
        "page": 6,
    ...
    {
        "page": 6,
        "q": "Why was my contactless payment declined?",
        "expect": ["security", "pin"],
    },
    {"page": 6, "q": "Do you charge for ATM withdrawals?", "expect": ["no", "free"]},
    {
        ...
        "expect": ["yes", "allowance"],
    },
    {
        "page": 6,
        "q": "How do I transfer an existing ISA to you?",
        "expect": ["official", "transfer"],
    },
    # --- PAGE 7 ---
    {
        "page": 7,
        "q": "What is a Notice Savings Account?",
        "expect": ["notice", "withdrawal"],
    },
    {
        "page": 7,
    ...
    {
        "page": 7,
        "q": "Can I open a savings account for my child?",
        "expect": ["junior", "children"],
    },
    {
        "page": 7,
        "q": "What is an Arranged Overdraft?",
        "expect": ["pre-agreed", "limit"],
    },
    {
        "page": 7,
        "q": "Will applying for an overdraft affect my credit score?",
        "expect": ["yes", "hard check"],
    },
    {
        "page": 7,
    ...
    },
    {
        ...
        "expect": ["penalty", "mortgage"],
    },
    {
        "page": 8,
        "q": "Can I port my mortgage if I move house?",
        "expect": ["yes", "portable"],
    },
    {
        "page": 8,
        "q": "What is the difference between Fixed and Tracker mortgage?",
        "expect": ["guarantees", "fluctuates"],
    },
    ...
    {
        "page": 9,
        "q": "How do I view my PIN in the app?",
        "expect": ["card management", "biometric"],
    },
    ...
    {
        "page": 10,
        "q": "Will you monitor my social media accounts?",
        "expect": ["no", "fraud"],
    },
    {
        "page": 10,
        "q": "Do you use automated decision making for loans?",
        "expect": ["yes", "manual review"],
    },
    {
        "page": 10,
    ...
    {
        "page": 10,
        "q": "Who can access the funds of a deceased customer?",
        "expect": ["executor", "administrator"],
    },
    {
        "page": 10,
        "q": "Do you have a sign language interpreter service?",
        "expect": ["yes", "signvideo"],
    },
    # --- PAGE 11 ---
    {
        "page": 11,
...
async def run_test():
    ...
    if failed > 0:
        print(
            "💡 TIP: Failures may suggest weak semantic matching for specific phrasing."
        )
        print(
            "        Consider using a Re-Ranker or Hybrid Search (Keyword + Vector) for 100% accuracy."
        )
