...
def downgrade() -> None:
    ...
    op.create_index(
        op.f("ix_customers_is_active"), "customers", ["is_active"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_customer_name"),
        "customers",
        ["first_name", "last_name"],
        unique=False,
    )
    op.create_index(
        op.f("idx_active_vip"), "customers", ["is_active", "is_vip"], unique=False
    )
    op.create_table(
        "transactions",
        sa.Column("account_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "reference", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        sa.Column(
            "amount",
        ...
        sa.Column(
            "merchant_name", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
        sa.Column(
            "id",
            sa.INTEGER(),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM(
                "CUSTOMER", "AGENT", "SYSTEM", "HUMAN_AGENT", name="messagerole"
            ),
            autoincrement=False,
            nullable=False,
    ...
    op.create_index(
        op.f("ix_messages_requires_human"), "messages", ["requires_human"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_requires_human"), "messages", ["requires_human"], unique=False
    )
    op.create_index(
        op.f("idx_conversation_intent"),
        "messages",
        ["conversation_id", "intent"],
        unique=False,
    )
    op.create_index(
        op.f("idx_conversation_created"),
        "messages",
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            autoincrement=False,
            nullable=True,
            comment="Annual interest rate (decimal)",
        ),
        sa.Column(
            "features",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "ACTIVE", "RESOLVED", "ESCALATED", "CLOSED", name="conversationstatus"
            ),
            autoincrement=False,
            nullable=False,
        ...
        sa.Column(
            "channel",
            postgresql.ENUM(
                "WEB", "MOBILE", "API", "WHATSAPP", "SMS", name="conversationchannel"
            ),
            autoincrement=False,
            nullable=False,
        ...
        sa.ForeignKeyConstraint(
            ["customer_id"],
            ["customers.id"],
            name=op.f("conversations_customer_id_fkey"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_conversations_intent"), "conversations", ["intent"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("idx_customer_status"),
        "conversations",
        ["customer_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("idx_channel_status"), "conversations", ["channel", "status"], unique=False
    )
    op.create_table(
        "document_chunks",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_document_chunks_filename"),
        "document_chunks",
        ["filename"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "type",
            postgresql.ENUM("CURRENT", "SAVINGS", "LOAN", "CREDIT", name="accounttype"),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column(
            "status",
            postgresql.ENUM("ACTIVE", "FROZEN", "CLOSED", name="accountstatus"),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["product_id"], ["products.id"], name=op.f("accounts_product_id_fkey")
        ),
