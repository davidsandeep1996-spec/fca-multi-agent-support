...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "notes", sa.Text(), nullable=True, comment="Internal notes about customer"
        ),
        sa.Column(
            "id",
            sa.Integer(),
    ...
    op.create_index(
        "idx_active_vip", "customers", ["is_active", "is_vip"], unique=False
    )
    op.create_index(
        "idx_customer_name", "customers", ["first_name", "last_name"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_channel_status", "conversations", ["channel", "status"], unique=False
    )
    op.create_index(
        "idx_customer_status", "conversations", ["customer_id", "status"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("CUSTOMER", "AGENT", "SYSTEM", "HUMAN_AGENT", name="messagerole"),
            nullable=False,
